...
export function RegistrarCategorias({ onClose, dataSelect, accion }) {
  ...
  // Función que rescata el emoji seleccionado
  function onEmojiClick(emojiObject) {
    setEmojiselect(() => emojiObject.emoji);
    setShowPicker(false);
  }

  // Función que elige el color
  ...
  // Función que rescata e inserta la data
  async function insertar(data) {
    if (accion === "Editar") {
      ...
      try {
        ...
        alert(error.error_description || error.message + "error ingresar Form");
      }
    }
  }
